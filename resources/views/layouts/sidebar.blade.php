<aside class="sidebar">
    <div class="sidebar-header">
        <a href="{{ route('dashboard') }}">
            ...
            <span>{{ config('app.name', 'ChurchMS') }}</span>
        </a>
    </div>
    <nav class="sidebar-nav">
        <ul>
            ...
            @if (auth()->user() && (auth()->user()->hasRole('Admin') || auth()->user()->hasRole('Senior Pastor')))
                ...
                <li>
                    <a href="{{ route('visitors.admin.index') }}" class="{{ request()->routeIs('visitors.admin.*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="{{ route('incomes.index') }}" class="{{ request()->routeIs('incomes.*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
